...
public class ManageUserinfoQueryOneParam implements Serializable
{
	...
	public String toString()
	{
		return "ManageUserinfoQueryOneParam [dynamicColumns=" + Arrays.toString(dynamicColumns) + ", dynamicWhere=" + dynamicWhere.toString() + "]";
	}
}
