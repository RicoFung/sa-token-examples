...
public class AppMenuQueryOneParam implements Serializable
{
	...
	public String toString()
	{
		return "AppMenuQueryOneParam [dynamicColumns=" + Arrays.toString(dynamicColumns) + ", dynamicWhere=" + dynamicWhere.toString() + "]";
	}
}
