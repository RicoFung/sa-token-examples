...
@Schema(description = "AppMenuQueryListRequest 列表入参")
public class AppMenuQueryListRequest implements Serializable
{
	...
	@Schema(title = "动态排序", example = "[{\"sortName\":\"id\",\"sortOrder\":\"DESC\"}]")
	...
	// 2.表单参数
	// ********************************************************************************************
	@Schema(title = "动态过滤", name="DynamicWhere(AppMenuQueryListRequest)", description="DynamicWhere(AppMenuQueryListRequest)")
	...
	public String toString()
	{
		return "AppMenuQueryListRequest [dynamicColumns=" + Arrays.toString(dynamicColumns) + ", dynamicOrder="
